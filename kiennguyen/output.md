# <span style="font-size:26.0pt;line-height:115%;
color:#17365D;letter-spacing:.25pt;font-weight:normal">Financial Statement Data
Sets</span>

# Contents

[1Overview.. 1](#_Toc407035363)
[2Scope. 2](#_Toc407035364)
[3Organization. 2](#_Toc407035365)
[4File Formats. 3](#_Toc407035366)
[5Table Definitions. 3](#_Toc407035367)
[5.1SUB (Submissions)3](#_Toc407035368)
[5.2TAG (Tags)7](#_Toc407035369)
[5.3NUM (Numbers)7](#_Toc407035370)
[5.4PRE (Presentation of Statements)8](#_Toc407035371)


[Figure 1. Data relationships. 3](#_Toc407035372)
[Figure 2. Fields in the SUB data set4](#_Toc407035373)
[Figure 3. Fields in the TAG data set7](#_Toc407035374)
[Figure 4. Fields in the NUM data set8](#_Toc407035375)
[Figure 5. Fields in the PRE data set8](#_Toc407035376)
...
</span><b>SUB</b>– Submission data set; this includes one record for each XBRL
...
- <span style="font-family:
Symbol">·</span><span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>         
</span><b>NUM</b>– Number data set; this includes one row for each distinct
...
- <span style="font-family:
Symbol">·</span><span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>         
</span><b>TAG</b>– Tag data set; includes defining information about each numerical
tag.  Information includes tag descriptions (documentation labels),
taxonomy version information and other tag attributes.
- <span style="font-family:
Symbol">·</span><span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>         
</span><b>PRE</b>– Presentation data set; this provides information about how
...
</span>Numeric data on the primary financial statements as rendered by the
...
- <span style="font-family:Symbol">·</span><span style='font-size:7.0pt;line-height:
115%;font-family:"Times New Roman",serif'>         
</span>From XBRL  submissions which include financial statements rendered by
the Commission  (e.g., 10-K, 10-Q, 20-F, 40-F);
- <span style="font-family:Symbol">·</span><span style='font-size:7.0pt;line-height:
115%;font-family:"Times New Roman",serif'>         
</span>Submitted from 4/15/2009 through the “Data Cutoff Date” inclusive (there
...
7.0pt;line-height:115%;font-family:"Times New Roman",serif'>    </span>SUB
...
unique (primary) key<b>adsh, </b>a 20 character EDGAR Accession Number with
dashes in positions 11 and 14.
- 2.<span style='font-size:
7.0pt;line-height:115%;font-family:"Times New Roman",serif'>    </span>TAG
...
- 1)<span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>   
</span><b>tag – </b>tag used by the filer
- 2)<span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>   
</span><b>version</b>– if a standard tag, the taxonomy of origin, otherwise
equal to adsh.
- 3.<span style='font-size:
7.0pt;line-height:115%;font-family:"Times New Roman",serif'>    </span>NUM
...
- 1)<span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>   
</span><b>adsh</b>- EDGAR accession number
- 2)<span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>   
</span><b>tag – </b>tag used by the filer
- 3)<span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>   
</span><b>version</b>– if a standard tag, the taxonomy of origin, otherwise
equal to adsh.
- 4)<span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>   
</span><b>ddate</b>- period end date
- 5)<span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>   
</span><b>qtrs</b>- duration in number of quarters
- 6)<span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>   
</span><b>uom -</b>unit of measure
- 7)<b>segments</b>– XBRL tags used to represent axis and member reporting
- 8)<span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>   
</span><b>coreg -</b>coregistrant of the parent company registrant (if
applicable)
- 4.<span style='font-size:
7.0pt;line-height:115%;font-family:"Times New Roman",serif'>    </span>PRE
...
- 2)<span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>   
</span><b>report</b>– sequential number of report within the statements
- 3)<span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>   
</span><b>line</b>– sequential number of line within a report.
The relationship of the data sets is as shown in Figure 1.
The Accession Number<b>(adsh)</b>found in the NUM data set can be used to
...
**<a name="_Ref367881788"></a><a name="_Toc407035372"></a><a name="_Toc367778100"></a>Figure 1. Data relationships**
...
<a name="_Toc367778231">Note: The SEC website folder http://www.sec.gov/Archives/edgar/data/{<b>cik</b>}/{<b>accession</b>}/
will always contain all the files for a given submission, where {<b>accession</b>}
is the <b>adsh</b> with the ‘-‘characters removed.</a>
...
- <span style="font-family:Symbol">·</span><span style='font-size:7.0pt;line-height:
115%;font-family:"Times New Roman",serif'>         
</span>EDGAR indicates that the source of the data is the filer’s EDGAR
submission header.
- <span style="font-family:Symbol">·</span><span style='font-size:7.0pt;line-height:
115%;font-family:"Times New Roman",serif'>         
</span>XBRL indicates that the source of the data is the filer’s XBRL
submission.
...
- <span style="font-family:
Symbol">·</span><span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>         
</span><span style="font-size:12.0pt;line-height:115%">“*”</span>– Indicates
the field is part of a unique key for the row.
- <span style="font-family:
Symbol">·</span><span style='font-size:7.0pt;line-height:115%;font-family:"Times New Roman",serif'>         
</span>Empty (nothing in column) – the column is a function of all or some of a
unique key.
## 5.1SUB
(Submissions)
...
**<a name="_Toc367778102"></a><a name="_Toc407035373"></a>Figure
...
<a name="_Toc367993103"></a>

Note: To access the complete submission files for a given
filing, please see the[SEC EDGAR website](http://sec.gov). 
The SEC website folder http://www.sec.gov/Archives/edgar/data/{<b>cik</b>}/{<b>accession</b>}/
...
{<b>cik</b>} with the<b>cik</b>field and replace {<b>accession</b>} with the<b>adsh</b>field (after removing the dash character).  The following sample SQL Query
...
</span><span style='font-family:"Courier New"'>select name,form,period,
'http://www.sec.gov/Archives/edgar/data/' + ltrim(str(<b>cik</b>,10))+'/' +
replace(<b>adsh</b>,'-','')+'/'+<b>instance</b> as url from SUB sub order by
period desc, name</span>
...
taxonomies in[https://www.sec.gov/data-research/standard-taxonomies](https://www.sec.gov/data-research/standard-taxonomies).

**<a name="_Toc367778104"></a><a name="_Toc407035374"></a>Figure
...
**<a name="_Ref367881857"></a><a name="_Toc407035375"></a><a name="_Toc367778105"></a>Figure 4. Fields in the NUM data set**
...
**<a name="_Ref367881837"></a><a name="_Toc407035376"></a><a name="_Toc367778103"></a>Figure 5. Fields in the PRE data set**
